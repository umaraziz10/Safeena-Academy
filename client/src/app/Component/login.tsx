...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screloginen w-full overflow-hidden bg-gradient-to-br from-offwhite via-teal-light to-primary-light flex items-center justify-center p-4 md:p-6 lg:p-8">
     <FallingLeaves/>
      <div
